...
drop function if exists public.snapshot_card(uuid, uuid);
drop function if exists public.soft_delete_card(uuid, uuid);
drop function if exists public.revoke_card(uuid, uuid, text);
