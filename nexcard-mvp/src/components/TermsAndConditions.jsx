    ...
    <div className="min-h-screen bg-zinc-950 text-white px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold mt-6 mb-2">Términos y Condiciones</h1>
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">3. Proceso de compra</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">4. Despacho y entrega</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">5. Devoluciones y reembolsos</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">6. Uso del perfil digital</h2>
            <ul className="list-disc pl-6 space-y-2">
