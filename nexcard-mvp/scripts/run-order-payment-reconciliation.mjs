...
const opsSharedSecret = process.env.OPS_SHARED_SECRET;
...
if (!opsSharedSecret) {
  console.error(JSON.stringify({ success: false, error: 'Falta OPS_SHARED_SECRET para ejecutar reconciliación operacional' }));
  process.exit(1);
}
